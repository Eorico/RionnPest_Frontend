...
class IntroService(QObject):
    finished = pyqtSignal()
    def __init__(self, ui, api_service, sync_manager, timer):
        super().__init__()
        self.ui = ui
...
class IntroWindow(QMainWindow):
    ...
    def __init__(self, sync_manager, api_service):
        ...
        self.intro_service = IntroService(self.ui, self.api, self.sync_manager, self.timer)
        
        self.timer.timeout.connect(self.intro_service.update_progress_intro)
        self.timer.start(30)
