...
_BRAND_RULE_SS = """
QFrame {
    background-color: rgba(198, 246, 213, 0.30);
    border: none;
    max-height: 1px;
}
"""
...
_DIVIDER_SS = "background-color: #E2EDE7; border: none; max-height: 1px;"
...
class Ui_Login(object):
    ...
    def setupUi(self, Login):
        ...
        # ── Root container (rounded card with shadow) ─────────────────────────
        ...
        # Drop-shadow effect on the whole card
        ...
        right_layout.setAlignment(QtCore.Qt.AlignVCenter)

        # ── Close button (top-right) ──────────────────────────────────────────
        top_bar = QtWidgets.QHBoxLayout()
        top_bar.setContentsMargins(0, 20, 0, 0)
        top_bar.addStretch()
        ...
        self.usernameEdit.setFixedHeight(46)
        ...
        # Wrapper with QStackedLayout so eye button floats over the input
        pwd_wrapper = QtWidgets.QWidget()
        pwd_wrapper.setFixedHeight(46)
        ...
        self.passwordEdit.setFixedHeight(46)
        ...
        divider.setStyleSheet(_DIVIDER_SS)
        ...
        self.loginbutton.setFixedHeight(48)
