...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        # Try loading a custom icon; fall back to emoji
        ...
        # ── Thin accent line under header (matches RecycleBin) ────────────────
...
class ChemicalUsedWindow(QtWidgets.QMainWindow, _OpenAnimMixin):
    """
