...
class Ui_MainWindow(object):
    ...
    def setupUi(self, MainWindow):
        ...
        body_lay.addWidget(card, 1)   # stretch to fill available height
        ...
        self.undoBtn.setEnabled(False)   # disabled until there is history
